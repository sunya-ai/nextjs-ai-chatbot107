...
export function WorkflowStatus({
  ...
  return (
    <div className={cn('bg-white/80 dark:bg-black/40 backdrop-blur-sm text-gray-900 dark:text-zinc-100 rounded-lg border border-gray-200/50 dark:border-white/10 shadow-lg shadow-[#454b1b]/5 w-full max-w-sm overflow-hidden')}>
